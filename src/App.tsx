...
export default class App extends React.Component<{}, state>{
  ...
  callBackForFooterProfileButton() {
    ...
    this.setState({
      WhichComponent: "person", componentToRender: <Profile ProfileName="Jerry Satpathy" ProfileDesc="I am an Inception" ImageUrl="https://imgplaceholder.com/420x320/ff7f7f/333333/fa-image"
    ...
    return (
      <Container>
        ...
        <Footer>
          ...
          <FooterWithButton callBackForHomeButton={this.callBackForFooterHomeButton} callBackForProfileButton={this.callBackForFooterProfileButton} activeButton={this.state.WhichComponent} />
        </Footer>
      </Container>
